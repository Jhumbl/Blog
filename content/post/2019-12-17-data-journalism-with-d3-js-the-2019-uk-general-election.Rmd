---
title: Data Journalism with D3.js - The 2019 UK General Election
author: Jack
date: '2019-12-17'
slug: data-journalism-with-d3-js-the-2019-uk-general-election
categories: []
tags: []
---
...
Below is a fully interactive exploratory visualisation of the results for this election:

* Select a constitueny on the map to see the results for that area.  
* Select a candidate on the bar chart to view their information.  
* Click the hexmap button to see a visual connection between the political hex map and the regular map.
...
<h2>D3.js</h2>
This visualisation was created with D3.js (Data Driven Documents), a javascript library allowing users to bind data to elements of the document object model and draw svg elements whose attributes are determined by the underlying data. More information can be found at [https://d3js.org/](https://d3js.org/)
